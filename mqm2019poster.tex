...
\title{Symmetry in Multiple SCF Solutions of Transition\textendash Metal Complexes}

\author{Bang C. Huynh\textsuperscript{$\dagger$} \inst{1} \and Alex J. W. Thom \inst{1}}

\institute[shortinst]{\inst{1} University of Cambridge}
