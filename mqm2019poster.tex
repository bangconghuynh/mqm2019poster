...
\begin{columns}[t]
	...
	\begin{column}{\colwidth}
		...
		\begin{block}{Introduction}
			...
			We have located these solutions using SCF metadynamics and investigated their symmetry properties in a model octahedral \ce{[VF6]^{3-}} system (\cref{fig:d2_allnoci}).
	  	\end{block}
